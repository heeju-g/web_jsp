	...
	<tr>
		...
		<tr>
			...
			<td colspan="2" align="right">
				<input type="button" value="수정" onclick="location.href='./myupdateform?seq=<jsp:getProperty property="seq" name="dto"/>'"/>
				<input type="button" value="삭제" onclick="location.href='./mydelete?seq=<jsp:getProperty property="seq" name="dto"/>'"/>
